    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Update produk</h4>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        @if (Session::has('productUpdateError'))
                            <div class="alert alert-danger">
                                <?php echo Session::get('productUpdateError'); ?>
                            </div>
                        @endif
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-4">
                                        ...
                                        <div class="product-img">
                                            <img src="{{ asset($product->image) }}" id="load-image">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" data-placeholder="Choose a Category" tabindex="1"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}" <?php echo $category->id == $product->id_categories ? 'selected' : ''; ?>>
                                                        {{ $category->category }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="status" name="status"
                                                    class="custom-control-input" value="publish" <?php echo $product->status == 'publish' ? 'checked' : ''; ?>> <label
                                                    class="custom-control-label" for="status">Publish</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="status2" name="status"
                                                    class="custom-control-input" value="unpublish" <?php echo $product->status == 'unpublish' ? 'checked' : ''; ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" placeholder="Harga"
                                                    ...
                                                    aria-describedby="basic-addon1" value="{{ $product->old_price }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="tags-default">
                                                <input type="text" value="{{ $product->variant }}"
                                                    data-role="tagsinput" placeholder="+ varian" name="variant" />
                                            </div>
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Size</label>
                                            <div class="tags-default">
                                                <input type="text" value="{{ $product->size }}" data-role="tagsinput"
