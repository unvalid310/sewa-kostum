                                ...
                                @foreach ($cart as $product)
                                    ...
                                    <tr id="data">
                                        <td class="pro-thumbnail" data-id="{{ $product->id_cart }}">
                                            <a href="#"><img class="img-fluid w100" src="{{ asset($product->image) }}"
                                                    alt="Product" /></a>
                                        </td>
                                        <td class="pro-title" data-product="{{ $product->id_products }}"
                                            data-variant="{{ $product->id_products }}" data-size="{{ $product->size }}">
                                        ...
                                        <td class="pro-subtotal"><span>{{ rupiah($product->price * $product->qty) }}</span>
                                        </td>
                                        <td class="pro-remove" width="5%"><a href="#"><i
